    ...
    <div className="flex min-h-[calc(100vh-10rem)] items-center justify-center py-12 px-4">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center space-y-1">
          ...
          <CardDescription className="!mt-2">Sign in to access your StudyU dashboard.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              <Label htmlFor="email">Email Address/Matric Number</Label>
              <Input 
                id="email" 
                type="text" 
                placeholder="you@example.com or 21010301016" 
                required 
                value={email}
